...
const Navbar = ({navigateCart, navigateHome}) => {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.item}>
          <Image className={styles.logo} src={pizzaLogo} alt="logo" width={100} height={80} onClick={navigateHome}/>
      ...
      <div className={styles.item}>
        <div className={styles.cart} onClick={navigateCart}>
